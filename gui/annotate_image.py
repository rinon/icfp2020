...
# From https://message-from-space.readthedocs.io/en/latest/message2.html
...
class Svg:
    ...
    def annotation(self, x, y, w, h, text):
        ...
        style = "paint-order: stroke; fill: white; stroke: black; stroke-width: 4px; font:48px bold sans;"
        self._print(
            f'<text x="{x*8+w*4}" y="{y*8+h*4}" dominant-baseline="middle" text-anchor="middle" fill="white" font-size="32px" style="{style}">{text}</text>'
        )
